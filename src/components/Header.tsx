...
import { Calendar, Menu, X, ArrowRight, Bell, Trophy, Brain } from "lucide-react";
...
export const Header = memo(({ currentSeason = "2023-2024", className = "" }: HeaderProps) => {
  ...
  const navLinks = [
    ...
    { text: "Bajnokság", href: "/leagues", icon: <Trophy className="w-4 h-4" /> },
  ];
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
      ...
      {mobileMenuOpen && (
        <div className="md:hidden fixed inset-0 top-[72px] bg-black/80 backdrop-blur-xl z-40">
